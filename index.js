...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/sinsrakzz/", "_blank");
    }
    if (x == 2) {
        window.open("https://youtube.com/@sinsrakzz?si=LC1RFN-jzaXRURnG", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/RakaWiryaKusuma", "_blank");
    }
    if (x == 4) {
        window.open("https://x.com/rakzzknz", "_blank");
    }
}